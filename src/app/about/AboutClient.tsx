...
const AboutClient = () => {
  ...
  const commitments = [
      ...
      },
      {
          ...
          description: 'With over 15 years in alternative medicine, our therapist brings a wealth of knowledge and expertise to every session.' 
      }
  ];
    ...
    <main className="bg-white text-gray-800">
      <section className="relative bg-gray-800 text-white py-32 sm:py-48 flex items-center justify-center">
        ...
        <div className="relative container mx-auto px-6 text-center z-10">
          ...
          <motion.p
            ...
            className="mt-4 text-lg sm:text-2xl text-gray-200 max-w-xl sm:max-w-3xl mx-auto"
          >
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-12 md:px-20 lg:px-32 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <motion.div variants={fadeInLeft} className="text-center lg:text-left">
            ...
            <p className="mt-4 sm:mt-6 text-base sm:text-lg text-gray-600 text-justify">
      ...
      >
        <div className="container mx-auto px-4 sm:px-12 md:px-20 lg:px-32 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div variants={fadeInRight} className="order-2 lg:order-1 text-center lg:text-left">
      ...
      <section className="bg-[#F0FDF4] py-16 sm:py-24"> 
