...
export const metadata: Metadata = {
    title: "Hijama & Cupping Therapy Blog | Wellness Insights from Al Madina Center", 
    description: "Read our latest articles on Sunnah healing, detoxification, chronic pain management, and the holistic benefits of Hijama cupping therapy by certified specialists in Lahore.",
};
