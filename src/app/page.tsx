...
  // Conversion tracking added here (Step 3.5)
...
                onClick={(e) => {
                  if (currentSlide.buttonLink.startsWith('tel:')) {
                    if (typeof window !== 'undefined' && (window as any).gtag_report_conversion) {
                      e.preventDefault();
                      (window as any).gtag_report_conversion(currentSlide.buttonLink);
                    }
                  }
                }}
...
                    if (typeof window !== 'undefined' && (window as any).gtag_report_conversion) {
                      e.preventDefault();
                      (window as any).gtag_report_conversion('tel:+92 300 7598000');
                    }
                  }}
