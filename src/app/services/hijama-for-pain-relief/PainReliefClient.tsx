...
// JSON-LD Schema data
// Optimized JSON-LD Schema for Service
const schema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Hijama for Pain Relief in Lahore",
  "description": "A targeted natural therapy using Blood or Dry cupping to effectively manage chronic pain and reduce inflammation without medication.",
