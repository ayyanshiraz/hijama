...
// Optimized JSON-LD Schema for Wet Cupping Service
const schema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Wet Cupping (Hijama) in Lahore",
  "description": "A traditional Prophetic method of healing creating suction to draw out toxins. This wet cupping therapy helps treat chronic pain, inflammation, migraines, and poor circulation while boosting the immune system.",
  "serviceType": "Wet Cupping Therapy",
  "provider": {
