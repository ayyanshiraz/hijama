...
// Optimized JSON-LD Schema for Detox and Wellness Service
const schema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Hijama for Detox and Wellness in Lahore",
  "description": "A comprehensive Hijama therapy in Lahore focused on purifying the body and removing toxins. This cupping treatment on Sunnah points of the back and shoulders helps with fatigue, general well being, and detoxification to boost overall vitality.",
  "serviceType": "Detox and Wellness Hijama Therapy",
  "provider": {
