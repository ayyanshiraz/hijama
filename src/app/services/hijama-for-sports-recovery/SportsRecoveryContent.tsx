...
// Optimized JSON-LD Schema for Sports Recovery Service
const schema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Hijama for Sports Recovery in Lahore",
  "description": "A specialized Hijama therapy in Lahore designed for athletes to accelerate muscle repair, reduce soreness, and enhance performance. This cupping treatment helps with muscle strain, sports injuries, and deep tissue tension on the back, legs, and shoulders.",
  "serviceType": "Sports Recovery Hijama Therapy",
  "provider": {
