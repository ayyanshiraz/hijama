...
export const metadata: Metadata = {
  ...
  description: "Book the best home beauty Hijama and facial cupping service in Lahore. Certified female staff for glowing skin and natural facelifts. 24/7 available.",
  alternates: {
