...
// Optimized JSON-LD Schema for Internal Health Service
const schema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Hijama for Internal Health in Lahore",
  "description": "A restorative Hijama therapy in Lahore focused on managing internal health issues. This cupping service targets specific points on the back, neck, and abdomen to help with high blood pressure, diabetes mellitus, digestive diseases, and high cholesterol.",
  "serviceType": "Internal Health Hijama Therapy",
  "provider": {
