...
// Optimized JSON-LD Schema for Fire Cupping Service
const schema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Fire Cupping Therapy in Lahore for Pain Relief",
  "description": "Find certified Fire Cupping specialists in Lahore for deep pain relief. Our female staff provides 24/7 home service with complete privacy. This Chinese cupping therapy on the back, neck, shoulders, and legs helps treat chronic pain, muscle tension, respiratory issues, and stress.",
  "serviceType": "Fire Cupping Therapy",
  "provider": {
