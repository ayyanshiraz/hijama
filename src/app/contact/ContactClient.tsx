...
const contactDetails = [
  {
    ...
    href: `https://maps.app.goo.gl/jLhgtoHjGCJhQPon7`,
  },
  {
    icon: Phone,
    title: `Call Us`,
...
const faqs = [
    {
        ...
        answer: `Hijama is a traditional therapeutic method that involves creating suction on the skin using cups to draw out stagnant, toxic blood. This process helps to detoxify the body, improve circulation, and stimulate the natural healing processes of the body.`
    },
    {
            ...
            <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-start`}>
              ...
              >
                ...
                <motion.div variants={fadeInUp} className={`rounded-lg overflow-hidden`}>
                  <iframe
                    src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3406.6005800486446!2d74.18211697441808!3d31.369999554558035!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3918ffe68d865491%3A0xe0baf4f3c53bc165!2sAl-Madina%20Hijama%20Center!5e0!3m2!1sen!2s!4v1774348241756!5m2!1sen!2s`}
                    width={`100%`}
                    height={`300`}
                    style={{ border: 0 }}
              ...
              return (
                <div key={index}>
                  <button
                    ...
                    className={`w-full flex justify-between items-center text-left gap-4 bg-[#1E4137] p-6 text-white transition-all duration-300 ` + (isOpen ? `rounded-t-lg` : `rounded-lg hover:bg-opacity-90`)}
                  >
